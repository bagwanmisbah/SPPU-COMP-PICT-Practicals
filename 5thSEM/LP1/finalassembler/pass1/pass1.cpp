...
void readSymFile(const string &filename);
void readLitFile(const string &filename);
void readPoolFile(const string &filename);

int main()
{
    // Your original code to process the input file
    ...
    // Demonstrate reading the files
    readOutputFile("output.txt");
    readSymFile("sym.txt");
    readLitFile("lit.txt");
    readPoolFile("pool.txt");
...
void readSymFile(const string &filename)
{
    ifstream fin(filename);
    string line;
    cout << "\nReading Symbol Table File:" << endl;
    while (getline(fin, line))
    {
        cout << line << endl;
    }
...
void readLitFile(const string &filename)
{
    ifstream fin(filename);
    string line;
    cout << "\nReading Literal Table File:" << endl;
    while (getline(fin, line))
    {
        cout << line << endl;
    }
